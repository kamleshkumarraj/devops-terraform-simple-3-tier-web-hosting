...
# resource "aws_placement_group" "frontend_asg_placement_group" {
#   name     = "frontend-asg-placement-group"
#   strategy = "cluster"
# }
...
resource "aws_autoscaling_group" "ecommerce_frontend_asg" {
  ...
  launch_template {
  id      = aws_launch_template.ecommerce_frontend_lt.id
  version = "$Latest"
}
...
resource "aws_autoscaling_policy" "memory_target_tracking_policy" {
  ...
  target_tracking_configuration {
    ...
    customized_metric_specification {
      ...
      #   value = aws_autoscaling_group.ecommerce_frontend_asg.name
      # }
    }
